...
def oracle_selections(Q: list) -> list:
    import pandas as pd
    df1 = pd.read_csv(
        '/home/oliver/Documents/github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/Nordlands_passes_recall@1_test.csv')
    df2 = pd.read_csv(
        '/home/oliver/Documents/github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/SFU_recall@1_test.csv')
    df3 = pd.read_csv(
        '/home/oliver/Documents/github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/StLucia_recall@1_test.csv')
    df4 = pd.read_csv(
        '/home/oliver/Documents/github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/GardensPointWalking_recall@1_test.csv')
