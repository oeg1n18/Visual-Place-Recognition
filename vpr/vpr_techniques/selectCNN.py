...
def oracle_selections(Q: list) -> list:
    import pandas as pd
    df1 = pd.read_csv('/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/Nordlands_passes_F-beta_test.csv')
    df2 = pd.read_csv(
        '/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/berlin_kudamm_F-beta_test.csv')
    df3 = pd.read_csv(
        '/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/ESSEX3IN1_F-beta_test.csv')
    df4 = pd.read_csv(
        '/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/GardensPointWalking_F-beta_test.csv')
    df5 = pd.read_csv(
        '/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/SFU_F-beta_test.csv')
    df6 = pd.read_csv(
        '/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/SPED_V2_F-beta_test.csv')
    df7 = pd.read_csv(
        '/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/selectCNN/data/StLucia_F-beta_test.csv')
    ...
    for q in Q:
        ...
        if np.max(df.iloc[idx].to_numpy()[2:].flatten()) < 0.1:
            selection = 3
        else:
            selection = np.argmax(df.iloc[idx].to_numpy()[2:].flatten())
