...
selection_model_pth = "/home/ollie/Documents/Github/Visual-Place-Recognition/vpr/vpr_techniques/techniques/switchCNN/weights/resnet9-f1-epoch=795-val_loss=0.00-other_metric=0.00.ckpt"
selection_transform = resnet_transforms_test
selection_model = resnet9regressionModule.load_from_checkpoint(checkpoint_path=selection_model_pth)
