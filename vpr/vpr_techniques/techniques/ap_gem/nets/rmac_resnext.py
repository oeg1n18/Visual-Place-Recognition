from vpr.vpr_techniques.techniques.ap_gem.nets.backbones.resnext101_features import *
from vpr.vpr_techniques.techniques.ap_gem.nets.layers.pooling import GeneralizedMeanPooling, GeneralizedMeanPoolingP
